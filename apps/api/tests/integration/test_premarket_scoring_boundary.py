"""Integration boundary tests for Premarket Scoring ↔ Watchlist/Gap."""
...
def test_scoring_consumes_watchlist_and_gaps_without_contract_changes() -> None:
