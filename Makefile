...
.PHONY: help helm-lint helm-template full-check verify-locks validate-secrets \
	...
	test-api-strategy-engine test-api-portfolio-service test-api-risk-engine \
...
help:
	...
	@echo "Sprint 4 targets: test-api-strategy-engine test-api-portfolio-service test-api-risk-engine test-api-order-management test-api-broker"
