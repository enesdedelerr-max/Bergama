...
.PHONY: help helm-lint helm-template full-check verify-locks validate-secrets \
	...
	test-api-strategy-engine test-api-strategy-sdk test-api-feature-platform test-api-premarket test-api-premarket-catalyst test-api-premarket-gap test-api-portfolio-service test-api-risk-engine \
...
help:
	...
	@echo "Sprint 7 targets: test-api-premarket test-api-premarket-catalyst test-api-premarket-gap"
